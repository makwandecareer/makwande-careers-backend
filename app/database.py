        ...
        with connection.cursor() as cursor:
            cursor.execute(
                ...
                CREATE TABLE IF NOT EXISTS education (
                    ...
                    qualification VARCHAR(240) NOT NULL,
                ...
                CREATE INDEX IF NOT EXISTS idx_cvs_owner
                    ON cvs(owner_id);

                CREATE INDEX IF NOT EXISTS idx_cvs_public
                    ON cvs(is_public_to_employers);
